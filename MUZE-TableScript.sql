...
DROP SEQUENCE SEQ_REVIEW_BOARD_NO;
DROP SEQUENCE SEQ_QNA_BOARD_NO;
DROP SEQUENCE SEQ_FAQ_BOARD_NO;
--자유게시글 테스트값
BEGIN
    FOR N IN 1..51
    LOOP
        ...
        VALUES( 
            'FREE-' || SEQ_FREE_BOARD_NO.NEXTVAL, 
            '테스트를 위한 자유게시글 ' || SEQ_FREE_BOARD_NO.CURRVAL, 
            '테스트를 위한 자유게시글 내용' || SEQ_FREE_BOARD_NO.CURRVAL, 
            SYSDATE, 
            0, 
...
BEGIN
    ...
    LOOP
        INSERT INTO BOARD(BRD_NO, BRD_TITLE, BRD_CONTENT, BRD_DATE, BRD_READCOUNT, BRD_WRITER_NO, BRD_TYPE, BRD_STATUS)
        VALUES( 
            'QNA-' || SEQ_QNA_BOARD_NO.NEXTVAL, 
            '테스트를 위한 QNA게시글 제목 ' || SEQ_QNA_BOARD_NO.CURRVAL, 
            '테스트를 위한 QNA게시글 내용' || SEQ_QNA_BOARD_NO.CURRVAL, 
            SYSDATE, 
            0, 
...
UPDATE BOARD SET BRD_CATEGORY = '상품' WHERE MOD(SUBSTR(BRD_NO, INSTR(BRD_NO, '-')+1),7) = 0 AND BRD_TYPE='QNA';
UPDATE BOARD SET BRD_CATEGORY = '주문/결제' WHERE MOD(SUBSTR(BRD_NO, INSTR(BRD_NO, '-')+1),7) = 1 AND BRD_TYPE='QNA';
UPDATE BOARD SET BRD_CATEGORY = '배송' WHERE MOD(SUBSTR(BRD_NO, INSTR(BRD_NO, '-')+1),7) = 2 AND BRD_TYPE='QNA';
UPDATE BOARD SET BRD_CATEGORY = '반품/환불' WHERE MOD(SUBSTR(BRD_NO, INSTR(BRD_NO, '-')+1),7) = 3 AND BRD_TYPE='QNA';
UPDATE BOARD SET BRD_CATEGORY = '이벤트' WHERE MOD(SUBSTR(BRD_NO, INSTR(BRD_NO, '-')+1),7) = 4 AND BRD_TYPE='QNA';
UPDATE BOARD SET BRD_CATEGORY = '회원/정보관리' WHERE MOD(SUBSTR(BRD_NO, INSTR(BRD_NO, '-')+1),7) = 5 AND BRD_TYPE='QNA';
UPDATE BOARD SET BRD_CATEGORY = '기타' WHERE MOD(SUBSTR(BRD_NO, INSTR(BRD_NO, '-')+1),7) = 6 AND BRD_TYPE='QNA';
...
BEGIN
    ...
    LOOP
        INSERT INTO BOARD(BRD_NO, BRD_TITLE, BRD_CONTENT, BRD_DATE, BRD_READCOUNT, BRD_WRITER_NO, BRD_TYPE, BRD_STATUS)
        VALUES( 
            'FAQ-' || SEQ_FAQ_BOARD_NO.NEXTVAL, 
            '테스트를 위한 FAQ게시글 제목 ' || SEQ_FAQ_BOARD_NO.CURRVAL, 
            '테스트를 위한 FAQ게시글 내용' || SEQ_FAQ_BOARD_NO.CURRVAL, 
            SYSDATE, 
            0, 
            TRUNC(DBMS_RANDOM.VALUE(2, 13)),
            'FAQ',
...
UPDATE BOARD SET BRD_CATEGORY = '상품' WHERE MOD(SUBSTR(BRD_NO, INSTR(BRD_NO, '-')+1),7) = 0 AND BRD_TYPE='FAQ';
UPDATE BOARD SET BRD_CATEGORY = '주문/결제' WHERE MOD(SUBSTR(BRD_NO, INSTR(BRD_NO, '-')+1),7) = 1 AND BRD_TYPE='FAQ';
UPDATE BOARD SET BRD_CATEGORY = '배송' WHERE MOD(SUBSTR(BRD_NO, INSTR(BRD_NO, '-')+1),7) = 2 AND BRD_TYPE='FAQ';
UPDATE BOARD SET BRD_CATEGORY = '반품/환불' WHERE MOD(SUBSTR(BRD_NO, INSTR(BRD_NO, '-')+1),7) = 3 AND BRD_TYPE='FAQ';
UPDATE BOARD SET BRD_CATEGORY = '이벤트' WHERE MOD(SUBSTR(BRD_NO, INSTR(BRD_NO, '-')+1),7) = 4 AND BRD_TYPE='FAQ';
UPDATE BOARD SET BRD_CATEGORY = '회원/정보관리' WHERE MOD(SUBSTR(BRD_NO, INSTR(BRD_NO, '-')+1),7) = 5 AND BRD_TYPE='FAQ';
UPDATE BOARD SET BRD_CATEGORY = '기타' WHERE MOD(SUBSTR(BRD_NO, INSTR(BRD_NO, '-')+1),7) = 6 AND BRD_TYPE='FAQ';
