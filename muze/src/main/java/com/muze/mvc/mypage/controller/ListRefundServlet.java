...
public class ListRefundServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public ListRefundServlet() {
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	if (loginMember != null) {
	    	...
	    	request.getRequestDispatcher("/views/mypage/list_refund.jsp").forward(request, response);
    	} else {
