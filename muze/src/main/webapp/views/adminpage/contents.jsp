          ...
          <div class="row" style="margin-bottom: 25px;">
            ...
            <div class="col-4">
                <ul class="pagination justify-content-center">
                    ...
                    <li class="page-item"><a class="page-link" href="${ path }/admin/content?page=${ pageInfo.nextPage }">&gt;</a></li>
                    <li class="page-item"><a class="page-link" href="${ path }/admin/content?page=${ pageInfo.maxPage }">&gt;&gt;</a></li>
