 ...
 <script>
    ...
    <div class="container">
        ...
        <div class="mt-5" style="border: 1px solid rgb(238, 233, 233);">
            ...
            <div>
            	<form name="form1" action="${ path }/product/painting/writer" method="POST" enctype="multipart/form-data">
                <table class="table m-0">
                    <thead>
                    	<input type="hidden" name="flag" value="i">
                    	<tr>
                            <th class="table-active" style="width: 20%;">작품타입</th>
                            <td style="width: 80%;"><input type="text" name="ptype" placeholder="회화" style="width: 80%;">
                            </td>
