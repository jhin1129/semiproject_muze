 ...
 <script>
    ...
    function product_write() {
       ...
       // 그리고 입력상태를 떠난 것을 포커스가 벗어났다고 한다.
        ...
        document.form1.action = "${path}/product/painting"; //페이지로 form1에 저장된 자료를 전송함
    ...
    <div class="container">
        ...
        <div class="mt-5" style="border: 1px solid rgb(238, 233, 233);">
            ...
            <div>
            	<form name="form1" action="${ path }/product/painting" method="POST" enctype="multipart/form-data">
                <table class="table m-0">
                    <thead>
                    	<input type="hidden" name="flag" value="i">
                    	<tr>
                            <th class="table-active" style="width: 20%;">작품타입</th>
                            <td style="width: 80%;"><input type="text" name="ptype" placeholder="회화, 유화, 조소" style="width: 80%;">
                            </td>
                        ...
                        <tr>
                            ...
                            <td style="width: 80%;"><input type="text" name="psize" placeholder="Cm사이즈 입니다. 예) 20 x 20." style="width: 80%;">
                            </td>
