                ...
                <table class="table m-0">
                    <thead>
                    	...
                    	<tr>
                            ...
                            <td style="width: 80%;"><input type="text" name="potype" placeholder="유화" style="width: 80%;">
                            </td>

                        </tr>
                        <tr>
                            <th class="table-active" style="width: 20%;">상품명</th>
                            <td style="width: 80%;"><input type="text" name="poname" placeholder="제목을 입력해주세요." style="width: 80%;">
                            </td>
                        ...
                        <tr>
                            ...
                            <td style="width: 80%;"><input type="text" name="pocount" placeholder="수량을 입력해주세요." style="width: 80%;">
                            </td>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="file" name="poimg"></input>
                        ...
                        <tr>
                            ...
                            <td style="width: 80%;"><input type="text" name="poprice" placeholder="가격을 입력해주세요." style="width: 80%;">
                            </td>
                        </tr>
                        <tr>
                			<td>상품설명</td>
               				<td><textarea rows="5" cols="60" name="poDescription"
