			...
			<form action="${ path }/board/update" method="POST" enctype="multipart/form-data">
	                ...
	                <table class="table m-0">
	                    <thead>
	                        <tr>
	                            ...
	                            <td style="width: 80%;">
	                            	<input type="text" name="title" placeholder="제목을 입력해주세요." value="${ board.brdTitle }" style="width: 80%;">
	                            </td>
	                        </tr>
	                    </thead>
	                    ...
	                    <tbody>
	                        <tr>
	                            ...
	                            <td>
	                            	<input type="text" name="writer" value="${ board.brdWriterId }" readonly style="border: 0px;">
	                            </td>
	                        </tr>
	            ...
	            <div class="my-3 px-3">
	                ...
	                <script>
	                    ...
	                    $('#summernote').summernote('code', '${board.brdContent}');
